...
Instructions:
- Pick up to 5 books from the list that are the best fit for this reader.
- For each pick, provide a short, fun, kid-friendly reason why it's great for them.
- Write a brief overall recommendation summary (2-3 sentences, kid-friendly tone).
